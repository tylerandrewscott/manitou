...
model_sets = list.files('output/policypolitics/model_objects/','fe_models')
...
fwrite(empty_list,'output/policypolitics/interaction_fe_results.csv')


#empty_list$outcome = name_matcher$outcome[match(empty_list$i,name_matcher$i)]

empty_list = fread('output/policypolitics/interaction_fe_results.csv')
...
ext_dt = empty_list[DV=='fe_Extractive',]
...
ggsave(gg_lcv_vs_unemp_extraction,dpi = 300,width = 6,height = 4.5, units = 'in',
       filename = paste0('output/policypolitics/figures/fe_interaction_extraction_projcount_lcv_vs_unemp.png'))
...
ggsave(gg_lcv_vs_unemp_extraction,dpi = 300,width = 6,height = 4.5, units = 'in',
       filename = paste0('output/policypolitics/figures/fe_interaction_extraction_CEratio_lcv_vs_unemp.png'))
...
ggsave(gg_percentD_H_vs_unemp_extraction,dpi = 300,width = 5,height = 4, units = 'in',
       filename = paste0('output/policypolitics/figures/fe_interaction_extraction_projcount_percentD_H_vs_unemp.png'))
...
(gg_percentD_H_vs_unemp_extraction = ggplot(data = ext_dt_dem[group=="CE/total NEPA analyses",],
  ...
  theme_bw() + theme(legend.position = c(0.2,0.15),legend.direction = 'vertical',
                     legend.title=element_text(size = 10),legend.background = element_rect(fill = alpha('white',0.25))))
ggsave(gg_percentD_H_vs_unemp_extraction,dpi = 300,width = 5,height = 4, units = 'in',
       filename = paste0('output/policypolitics/figures/fe_interaction_extraction_CEratio_percentD_H_vs_unemp.png'))
...
ggsave(gg_demRep_vs_unemp_extraction,dpi = 300,width = 5,height = 4, units = 'in',
       filename = paste0('output/policypolitics/figures/fe_interaction_extraction_projcount_demRep_vs_unemp_extraction.png'))
...
gg_demRep_vs_unemp_extraction = ggplot(data = ext_dt_rep[group=="CE/total NEPA analyses",],
  ...
  theme_bw() + theme(legend.position = c(0.2,0.15),legend.direction = 'vertical',
                     legend.title=element_text(size = 10),legend.background = element_rect(fill = alpha('white',0.25)))
ggsave(gg_demRep_vs_unemp_extraction,dpi = 300,width = 5,height = 4, units = 'in',
       filename = paste0('output/policypolitics/figures/fe_interaction_extraction_CEratio_demRep_vs_unemp_extraction.png'))
